<template>
  <div class="main-page">
    ...
    />
    <customer-service
        v-if="customerServiceFlag"
        :imQrCode="storeDetail.imQrCodeUrl"
        @close="customerServiceFlag = false"
    />
    <popups
...
import customerService from "@/components/m-customer-service/index";
...
export default {
  ...
  methods: {
    ...
    linkMsgDetail() {
      if (this.storeDetail.enableImQrCode) {
        this.customerServiceChange();
        return;
      }
