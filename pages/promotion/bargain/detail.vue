      ...
      <u-modal :show-title="false" v-model="helpBargainFlage" :show-confirm-button="false">
        <view class="help-bargain" @click="handleClickHelpBargain">
          <u-image width="100%" height="600rpx"
            src="https://qiezizhibo-1300664818.cos.ap-shanghai.myqcloud.com/sftgshop/app/bargain-background.png"></u-image>
...
.wrapper {
  background: url("https://qiezizhibo-1300664818.cos.ap-shanghai.myqcloud.com/sftgshop/app/bargain-background.png");
